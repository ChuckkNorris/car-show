...
const cars = [
  ...
  { id: 6, year: 1991, make: 'BMW', model: 'M3', description: 'Neat Bike!', horsepower: 110, imageUrl: 'https://i.imgur.com/ULeJbZ8.jpg'},
  { id: 7, year: 1991, make: 'BMW', model: 'Camaro', description: 'Neat Car!', horsepower: 190, imageUrl: 'https://i.imgur.com/NzRrvXW.png'},
  { id: 8, year: 1991, make: 'BMW', model: 'Golf R', description: 'Neat Car!', horsepower: 190, imageUrl: 'https://i.imgur.com/q0klba1.png'},
  ...
  { id: 10, year: 1991, make: 'BMW', model: 'M3', description: 'The winningest BMW ever made', horsepower: 190, imageUrl: 'https://i.imgur.com/nveAO0Z.png'},
];
